...
<div class="flex flex-col h-screen w-56 bg-[#3D2F2F] text-white dark:bg-[#464a4f] shadow-md position-relative">
    ...
    <div class="flex justify-start p-3 border-b border-white/10">
        ...
        <div x-data="{ open_user: false }" class="relative" >
            ...
            >
                <div class="p-0.5">
                    <button class="btn cursor-pointer border-gray-500 hover:">
                        EDITAR
                    </button>
                </div>
            </div>
